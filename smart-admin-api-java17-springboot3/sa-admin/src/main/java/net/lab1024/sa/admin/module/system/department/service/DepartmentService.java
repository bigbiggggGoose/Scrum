...
public class DepartmentService {
    ...
    public ResponseDTO<DepartmentVO> addDepartment(DepartmentAddForm departmentAddForm) {
        ...
        // 插入后通过主键查询完整 VO（含负责人姓名等扩展字段）
        DepartmentVO newDepartment = departmentDao.selectDepartmentVO(departmentEntity.getDepartmentId());
        this.clearCache();
        return ResponseDTO.ok(newDepartment);
    }
